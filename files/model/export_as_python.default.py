...
time_series = client.time_series("{selected_coverage}", (bands), {latitude}, {longitude}, "{start_date}", "{end_date}")

print(time_series.timeline)

# The x-axis will contain the time interval
x = [str(date) for date in time_series.timeline]

plt.title("Coverage " + str(), fontsize=14)
